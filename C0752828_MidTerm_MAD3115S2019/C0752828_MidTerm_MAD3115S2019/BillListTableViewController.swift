...
class BillListTableViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        let customer3 = Customer(customerId: 3, Customerfname: "Rohit", customerlname: "Sharma", customeremail: "rhoit@gmail.com", phoneNumber: "4267892087")
...
//        self.tblCustList.dataSource = self
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let  cell = tableView.dequeueReusableCell(withIdentifier: "custList") as! UITableViewCell
